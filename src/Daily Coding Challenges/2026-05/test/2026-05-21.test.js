...
describe('iBeforeE', () => {
  ...
  it("iBeforeE(\"she beleived the friendly niece could percieve the greif\") should return \"she believed the friendly niece could perceive the grief\"", () => {
    expect(iBeforeE("she beleived the friendly niece could percieve the greif")).toEqual("she believed the friendly niece could perceive the grief");
  });
  ...
  it("iBeforeE(\"we recieved relief after the theif gave us a breif piece of feirce deceit\") should return \"we received relief after the thief gave us a brief piece of fierce deceit\"", () => {
    expect(iBeforeE("we recieved relief after the theif gave us a breif piece of feirce deceit")).toEqual("we received relief after the thief gave us a brief piece of fierce deceit");
  });
});
